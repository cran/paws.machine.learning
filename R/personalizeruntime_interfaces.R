...
.personalizeruntime$get_personalized_ranking_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(personalizedRanking = structure(list(structure(list(itemId = structure(logical(0), tags = list(type = "string")), score = structure(logical(0), tags = list(type = "double"))), tags = list(type = "structure"))), tags = list(type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
...
.personalizeruntime$get_recommendations_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(itemList = structure(list(structure(list(itemId = structure(logical(0), tags = list(type = "string")), score = structure(logical(0), tags = list(type = "double"))), tags = list(type = "structure"))), tags = list(type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
